  ...
  instance
    .get(
      ...
      async (req) => {
        ...
        const res = await db
          ...
          .where(
            eq(
              absensi.id_pelaksanaan_pelatihan,
    ...
    .put(
      "/validasi/:id",
      {
        preHandler: [instance.authenticate],
        schema: {
          description: "validasi absensi trainee",
          tags: ["update"],
          headers: z.object({
            authorization: z
              .string()
    ...
    .get(
      "/materi/:id_materi/:id_pelaksanaan_pelatihan",
      {
        preHandler: [instance.authenticate],
        schema: {
    ...
    .get(
      "/exam/:id_exam/:id_pelaksanaan_pelatihan",
      {
        preHandler: [instance.authenticate],
        schema: {
          description: "get absensi",
